function generateHaiku(event) {
  ...
  let context = `You're a renowned poet who specialises in the japanese style of poems called Haiku, which is consisting of words with a total of seventeen syllables, arranged on three lines. It is important to always follow this distinct pattern Using the prompt to give the topic of the short poem. 
 `;
